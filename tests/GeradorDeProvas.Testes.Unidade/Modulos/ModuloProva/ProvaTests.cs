...
public sealed class ProvaTests
{
    ...
    public void Validar_SemTitulo_DeveRetornar_ErroCorrespondente()
    {
        ...
        Assert.AreEqual(
            "O campo \"Titulo\" deve conter entre 2 e 100 caracteres.",
            erros.First()
        );
    }
    ...
    public void Validar_SemDisciplina_DeveRetornar_ErroCorrespondente()
    {
        ...
        Prova prova = new Prova("Prova de Álgebra 8a série", null!, materia, 8, 1, false);
    ...
    public void Validar_ComSerieEMateria_Diferentes_DeveRetornar_ErroCorrespondente()
    {
        ...
        Assert.HasCount(1, erros);
        Assert.AreEqual(
            "O campo \"Série\" precisa alinhar com a serie da \"Matéria\".",
            erros.First()
        );
    }
    ...
    public void Validar_RecuperacaoComMateria_DeveRetornar_ErroCorrespondente()
    {
        ...
        Prova prova = new Prova("Recuperação de Matemática", disciplina, materia, 5, 1, true);
        ...
        Assert.HasCount(1, erros);
        Assert.AreEqual(
            "O campo \"Matéria\" não pode ser preenchido em uma prova de recuperação.",
            erros.First()
        );
    }
